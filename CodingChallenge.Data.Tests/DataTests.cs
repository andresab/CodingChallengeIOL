...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            ...
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>", PrinterService.Imprimir(new List<FormaGeometrica>()));
        }
        ...
        public void TestResumenListaVaciaFormasEnIngles()
        {
            ...
            Assert.AreEqual("<h1>Empty list of shapes!</h1>", PrinterService.Imprimir(new List<FormaGeometrica>()));
        }
